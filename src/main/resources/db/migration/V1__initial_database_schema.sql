...
CREATE TABLE BUDG_USER_XREFS (
  BUXF_ID_SEQ BIGINT(11)   NOT NULL AUTO_INCREMENT,
...
#   MOD_BY      VARCHAR(30)  NULL DEFAULT NULL,
#   DTM_MOD     TIMESTAMP    NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (BUXF_ID_SEQ),
  INDEX BUXF_BUDG_FK (BUDG_ID_SEQ),
  INDEX BUXF_USER_FK (USER_ID_SEQ)
)ENGINE =INNODB;

ALTER TABLE BUDG_USER_XREFS ADD CONSTRAINT BUXF_BUDG_FK FOREIGN KEY (BUDG_ID_SEQ) REFERENCES BUDGETS (BUDG_ID_SEQ);
ALTER TABLE BUDG_USER_XREFS ADD CONSTRAINT BUXF_USER_FK FOREIGN KEY (USER_ID_SEQ) REFERENCES USERS (USER_ID_SEQ);
